...
export default function VerifyEmailPage() {
  ...
  const handleVerify = async (e) => {
    ...
    if (!email) {
      setError("We couldn't find your email. Please go back and try signing up again.")
      return
    }
    ...
    try {
      ...
      if (response.success) {
        ...
        setError(response.error || "That code didn't work. Please double-check it and try again.")
      }
    } catch (err) {
      setError(err.message || "We couldn't verify your email. Please check the code and try again.")
    } finally {
      setLoading(false)
    }
  }
        ...
        <div className="relative z-10 space-y-6">
          ...
          <form onSubmit={handleVerify} className="space-y-6">
            ...
            <button
              ...
              className={`w-full py-3 rounded-xl font-medium text-white transition-all duration-200 ${loading || otp.length !== 6 || !email
          ...
          <div className="text-center">
            <p className="text-gray-400 text-sm">
              ...
              <button
                ...
                className={`font-medium transition ${resendCooldown > 0
