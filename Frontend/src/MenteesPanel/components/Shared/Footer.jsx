  ...
  return (
    <footer className="relative bg-gradient-to-br from-[#5D38DE] via-[#6B42E8] to-[#7C4DFF] text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-10">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-2">
                <svg className="w-4 h-4 text-purple-200 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="pt-6 border-t border-white/20">
          <p className="text-purple-200 text-sm text-center">
            © 2025 Scholarslee. All rights reserved.
          </p>
        </div>
      </div>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-11 h-11 bg-blue-500 hover:bg-blue-600 rounded-lg flex items-center justify-center shadow-lg transition-all duration-300 hover:scale-110 z-50"
